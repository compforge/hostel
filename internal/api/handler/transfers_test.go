...
func newTransferTestServer(t *testing.T, fixture *transferS3Fixture) (*testServer, *bed.Resident) {
	t.Helper()
...
func startTestTransfer(t *testing.T, s *testServer, req transferRequest, want int) apiview.Transfer {
	t.Helper()
...
func awaitTestTransfer(t *testing.T, s *testServer, id string) apiview.Transfer {
	t.Helper()
