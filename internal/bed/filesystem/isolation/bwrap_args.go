...
func buildBwrapArgs(workspaceRoot, bedHome, workspace string, projections []bedfs.PathProjection, cwd string, maskPaths []string, mappings []model.PathMapping) []string {
