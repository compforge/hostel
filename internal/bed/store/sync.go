...
func (s *Manager) runSync(ctx context.Context, interval time.Duration, syncBeds func(context.Context, string) ([]string, bool)) {
...
func (s *Manager) ConfigureSync(interval time.Duration, syncBeds func(context.Context, string) ([]string, bool)) {
	s.interval, s.syncBeds = interval, syncBeds
}
func (s *Manager) Run(ctx context.Context) error {
	...
	s.runSync(ctx, s.interval, s.syncBeds)
	return nil
}
