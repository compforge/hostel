...
│   ├── bed.go         Manager：Ensure(空→default，按 generation 判 luggage 新鲜)/BeginOperation/Evict/Purge/CollectExpired；ForegroundShell；StartCommand
